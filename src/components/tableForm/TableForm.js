    ...
    <form className={classes.root}>
      <Grid container>
        <Grid item xs={6}>
          ...
          <TextField variant="outlined" name="height" label="Width" value={values.width} />
          <TextField variant="outlined" name="width" label="Height" value={values.height} />
        </Grid>
        <Grid item xs={6}>
          ...
          <TextField variant="outlined" label="Chairs" value={values.chairs} />
          <TextField
